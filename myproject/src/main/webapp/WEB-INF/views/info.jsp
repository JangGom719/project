					...
					<td height="500"  bgcolor="#D9E5FF" align="center">
						...
						<table border="0" cellspacing="0" cellpadding="20">		
							...
							<form action="infoOk"  method="post" name="reg_frm">
								...
								<tr>
									<td class="td-type01">담당교수</td>
									<td><input id="input01" type="text" name="professor" readonly
									value="<%if(session.getAttribute("professor")!=null) {out.println(session.getAttribute("professor")); } 
									else {out.println("");} %>"></td>


									<td class="td-type01">학년</td>
									<td><input id="input01" type="text" name="year" readonly
									value="<%if(session.getAttribute("year")!=null) {out.print(session.getAttribute("year")); } 
									else {out.println("");} %>"></td>
								</tr>
